...
_designation['New_York_Manhattan_Zoning'] = [
    ...
    { 'code': 'BPC', 'description': 'SPECIAL BATTERY PARK CITY DISTRICT', 'color': "aqua" },
    
   { 'code': 'C1-6', 'description': 'Commercial', 'color': "aquamarine" },
 ...
 { 'code': 'C1-9', 'description': 'Commercial', 'color': "aquamarine" },
   { 'code': 'C1-9A', 'description': 'Commercial', 'color': "aquamarine" },
     ...
     { 'code': 'C2-6', 'description': 'Commercial', 'color': "blue" },
     { 'code': 'C2-6A', 'description': 'Commercial', 'color': "blue" },
     { 'code': 'C2-7', 'description': 'Commercial', 'color': "blue" },
     { 'code': 'C2-7A', 'description': 'Commercial', 'color': "blue" },
     { 'code': 'C2-8', 'description': 'Commercial', 'color': "blue" },
    ...
    { 'code': 'C4-7', 'description': 'Commercial', 'color': "blueviolet" },
    ...
    { 'code': 'C5-2.5', 'description': "Commercial", 'color': "brown" },
    ...
    { 'code': 'C6-2G', 'description': "Commercial", 'color': "chocolate" },
    ...
    { 'code': 'C6-4.5', 'description': "Commercial", 'color': "chocolate" },
    { 'code': 'C6-4A', 'description': "Commercial", 'color': "chocolate" },
    { 'code': 'C6-4M', 'description': "Commercial", 'color': "chocolate" },
    { 'code': 'C6-4X', 'description': "Commercial", 'color': "chocolate" },
   
    
    { 'code': 'C6-5', 'description': 'Commercial', 'color': "coral" },
    { 'code': 'C6-5.5', 'description': 'Commercial', 'color': "coral" },
    { 'code': 'C6-6', 'description': 'Commercial', 'color': "coral" },
    { 'code': 'C6-6.5', 'description': 'Commercial', 'color': "coral" },
    { 'code': 'C6-7', 'description': 'Commercial', 'color': "coral" },
    { 'code': 'C6-7T', 'description': 'Commercial', 'color': "coral" },
    ...
    { 'code': 'PARK', 'description': 'Park', 'color': "green" },
    
    
    
    { 'code': 'M1-5', 'description': 'Manufacturing', 'color': "hotpink" },
    { 'code': 'M1-5/R7-2', 'description': 'Manufacturing', 'color': "hotpink" },
    { 'code': 'M1-5/R7X', 'description': 'Manufacturing', 'color': "hotpink" },
    ...
    { 'code': 'M2-1', 'description': 'Manufacturing', 'color': "indigo" },      
   { 'code': 'M2-2', 'description': 'Manufacturing', 'color': "indigo" },   
   { 'code': 'M2-3', 'description': 'Manufacturing', 'color': "indigo" },   
   { 'code': 'M2-4', 'description': 'Manufacturing', 'color': "indigo" },   
   
   
   
     { 'code': 'M3-1', 'description': 'Manufacturing', 'color': "lime" },
      { 'code': 'M3-2', 'description': 'Manufacturing', 'color': "lime" },
     ...
     { 'code': 'R7B', 'description': "Residence", 'color': "peachpuff" },
     { 'code': 'R7D', 'description': "Residence", 'color': "peachpuff" },
     { 'code': 'R7X', 'description': "Residence", 'color': "peachpuff" },
     
     
     { 'code': 'R8', 'description': 'Residence', 'color': "plum" },
    { 'code': 'R8A', 'description': 'Residence', 'color': "plum" },
    { 'code': 'R8B', 'description': 'Residence', 'color': "plum" },
    { 'code': 'R8X', 'description': 'Residence', 'color': "plum" },
    
    
    
    { 'code': 'R9', 'description': 'Residence', 'color': "red" },
    { 'code': 'R9A', 'description': 'Residence', 'color': "red" },
